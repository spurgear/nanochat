...
if USE_FA3:
    ...
    print0("✓ Using Flash Attention 2 (Ampere/Ada GPU detected).")
else:
    print0("!" * 80)
    if HAS_FA3 and COMPUTE_DTYPE != torch.bfloat16:
        ...
        print0("WARNING: Install flash-attn for better throughput: pip install flash-attn --no-build-isolation")
